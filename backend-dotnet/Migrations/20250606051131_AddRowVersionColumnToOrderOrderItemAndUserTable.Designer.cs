...
namespace QuanNhauSanVuon.Migrations
{
    ...
    [Migration("20250606051131_AddRowVersionColumnToOrderOrderItemAndUserTable")]
    partial class AddRowVersionColumnToOrderOrderItemAndUserTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuanNhauSanVuon.Services.Entities.Order", b =>
                {
                    ...
                    b.Property<long>("CachedGrossAmount")
                        .HasColumnType("bigint")
                        .HasColumnName("cached_gross_amount");

                    b.Property<long>("CachedNetAmount")
                        .HasColumnType("bigint")
                        .HasColumnName("cached_net_amount");

                    b.Property<long>("CachedVatAmount")
                        .HasColumnType("bigint")
                        .HasColumnName("cached_vat_amount");
            ...
            modelBuilder.Entity("QuanNhauSanVuon.Services.Entities.Order", b =>
                {
                    ...
                    b.HasOne("QuanNhauSanVuon.Services.Entities.User", "LastUpdatedUser")
                        .WithMany("LastUpdatedOrders")
            ...
            modelBuilder.Entity("QuanNhauSanVuon.Services.Entities.User", b =>
                {
                    ...
                    b.Navigation("LastUpdatedOrders");
                });
